...
int main(void) {
    ...
    // Training Neural Network for numberOfEpochs
    ...
    for(int epoch = 0; epoch < numberOfEpochs; epoch++) {
        ...
        for (int x = 0; x < numTrainingSets; x++) {
            ...
            printf("Input: %g %g  Output: %g  Predicted Out: %g \n",
                    training_inputs[i][0], training_inputs[i][1], 
                    outputLayer[0], training_outputs[i][0]);
            
            // Back Propagation

            // 1. Compute change in the output weights
            ...
            // 2. Compute change in the hidden weights
            ...
            // 3. Apply change to output weights
            ...
            // 3. Apply change to hidden weights
